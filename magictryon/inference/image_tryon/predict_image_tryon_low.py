...
############### load test data ##############
cloth_id_book = [
    "013608_1.jpg", "013645_1.jpg", "014206_1.jpg",
    "013959_1.jpg", "013603_1.jpg",
    "014390_1.jpg", "013726_1.jpg", 
    "013669_1.jpg", "013621_1.jpg", "013679_1.jpg",  
]

video_id = ["050876_0.jpg", "050882_0.jpg", "050965_0.jpg", "050977_0.jpg", "051138_0.jpg"]


save_path = "samples/Image-Demo-low"
...
for cloth_id in cloth_id_book:
    ...
    for vid in video_id:
        mask_id = vid.replace('.jpg', '.png') 

        org_video_path = os.path.join("datasets/person/dresscode/lower_body/images/", vid)
        masked_video_path = os.path.join("datasets/person/dresscode/lower_body/agnostic/", mask_id)
        mask_video_path = os.path.join("datasets/person/dresscode/lower_body/mask/", mask_id)
        pose_video_path = os.path.join("datasets/person/dresscode/lower_body/image-densepose/", vid)
